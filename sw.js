...
const CACHE_NAME = 'mischicasnails-v49';
const urlsToCache = [
  '/mischicasnails/',
  '/mischicasnails/index.html',
  '/mischicasnails/admin.html',
  '/mischicasnails/admin-login.html',
  '/mischicasnails/calendar.html',
  '/mischicasnails/setup-wizard.html',
  '/mischicasnails/editar-negocio.html',
  '/mischicasnails/manifest.json',
  '/mischicasnails/icons/icon-72x72.png',
  '/mischicasnails/icons/icon-96x96.png',
  '/mischicasnails/icons/icon-128x128.png',
  '/mischicasnails/icons/icon-144x144.png',
  ...
  '/mischicasnails/utils/push-config.js',
  '/mischicasnails/utils/push-notifications.js'
];
      ...
      .catch(() => {
        ...
        return caches.match(event.request).then(cachedResponse => {
          ...
          if (event.request.url.match(/\.(jpg|jpeg|png|gif|svg|webp)$/)) {
            return caches.match('/mischicasnails/icons/icon-192x192.png');
          }
...
self.addEventListener('push', event => {
  ...
  const options = {
    ...
    icon: '/mischicasnails/icons/icon-192x192.png',
    badge: '/mischicasnails/icons/icon-96x96.png',
    tag: payload.tag || 'rservasroma',
    data: {
      url: payload.url || '/mischicasnails/admin.html',
      ...(payload.data || {})
    }
  };
...
self.addEventListener('notificationclick', event => {
  ...
  const targetUrl = event.notification?.data?.url || '/mischicasnails/admin.html';
  event.waitUntil(
...
console.log('✅ Service Worker configurado para Mis chicas Nails');
